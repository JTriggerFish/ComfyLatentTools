...
from diffusion import parse_unet_blocks, pag_perturbed_attention
...
class RescaledPAG:
    ...
    def patch(
        ...
        def cfg_function(args):
            ...
            v_final = v_out_normed * post_rescale + v_out_unnorm * (1 - post_rescale)
